...
console.log(
  "prakiraanCuaca.Tanggal:",
  new Date(prakiraanCuaca.Date).toString()
); // Diubah ke objek Date agar bisa dibaca
...
console.log(
  "prakiraanCuaca2.Tanggal:",
  new Date(prakiraanCuaca2.Date).toString()
);
